...
SELECT 'JA' AS nfl_team_code,
	   ...
	   CASE WHEN fts.DimTicketTypeId IN (1,2,3) THEN 1 ELSE 0 END AS SeasonTicketFlag, -- Update Season Ticket Holder Logic for your team here
	   CASE WHEN fts.DimTicketTypeId NOT IN (1,2,3) THEN 1 ELSE 0 END AS SingleGameFlag, -- Update Single Game Buyer Logic for your team here
	   fts.QtySeat,
	   fts.TotalRevenue
...
WHERE seasonname IN (
 '2015 Jaguars Manifest'
,'2016 Jaguars Season Tickets'
,'2017 Jaguars Manifest'
)
