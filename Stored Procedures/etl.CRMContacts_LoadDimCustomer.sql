...
CREATE PROCEDURE [etl].[CRMContacts_LoadDimCustomer]
AS
...
--drop table #temp
		...
		SELECT * INTO #temp FROM ods.vw_DynamicsContacts_LoadDimCustomer
...
/***Standard and Extended Attributes***/
	...
	--, myTarget.SalutationName = mySource.SalutationName
		...
		LEFT JOIN jaguars.prodcopy.contact b ON t.sourcesystem = 'CRM_Contacts' AND CAST(t.ssid AS NVARCHAR(100)) = CAST(b.contactid AS NVARCHAR(100))
