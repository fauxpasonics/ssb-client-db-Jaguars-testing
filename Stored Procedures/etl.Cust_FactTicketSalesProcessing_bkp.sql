...
CREATE PROCEDURE [etl].[Cust_FactTicketSalesProcessing_bkp]
(
	@BatchId INT = 0,
...
FROM    #stgFactTicketSales fts
		...
		JOIN [rpt].[PriceCodeDesignations_2017] dsg on dsg.PriceCode = pricecode.pricecode
