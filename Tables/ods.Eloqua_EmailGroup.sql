...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_C__79D4933A] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_U__7AC8B773] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_I__7BBCDBAC] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_EmailGroup] ADD CONSTRAINT [PK__Eloqua_E__3214EC272700B249] PRIMARY KEY CLUSTERED  ([ID])
GO
