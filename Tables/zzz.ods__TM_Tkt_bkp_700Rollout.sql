...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__InsertDa__2739D489] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__UpdateDa__282DF8C2] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[ods__TM_Tkt_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Tkt__3213E83E45F0307A] PRIMARY KEY NONCLUSTERED  ([id])
GO
...
GO
CREATE NONCLUSTERED INDEX [IDX_TM_Tkt_ticket_status2] ON [zzz].[ods__TM_Tkt_bkp_700Rollout] ([ticket_status]) INCLUDE ([acct_id], [add_datetime], [event_id], [order_line_item], [order_num], [plan_event_id], [row_id], [seat_num], [section_id])
GO
