...
[ExtAttribute5_ID] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
...
GO
CREATE NONCLUSTERED INDEX [IX_CompositeContacts_ExtAttribute5_ID] ON [mdm].[CompositeContacts] ([ExtAttribute5_ID]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
