...
(
[FactInventoryId] [int] NOT NULL IDENTITY(1000000000, 1),
...
GO
CREATE NONCLUSTERED INDEX [IDX_FactTicketSalesId] ON [dbo].[FactInventoryHistory] ([FactTicketSalesId])
GO
