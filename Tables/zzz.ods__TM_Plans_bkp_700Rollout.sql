...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Insert__19DFD96B] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Update__1AD3FDA4] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[ods__TM_Plans_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Plans__3213E83FF60A86BE] PRIMARY KEY CLUSTERED  ([id])
GO
