...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__InsertD__0C85DE4D] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__UpdateD__0D7A0286] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL,
[name_type] [nvarchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [zzz].[ods__TM_Cust_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Cust__3213E83F116094AE] PRIMARY KEY CLUSTERED  ([id])
GO
