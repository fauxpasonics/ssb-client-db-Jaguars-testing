...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Account__CopyLoa__68F354A4] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Account] ADD CONSTRAINT [PK__Account__F20699F6BEA2A773] PRIMARY KEY CLUSTERED  ([accountid])
GO
