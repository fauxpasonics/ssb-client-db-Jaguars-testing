...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__str_Ticke__CopyL__1F5A524D] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_TicketCase] ADD CONSTRAINT [PK__str_Tick__0D1656825D72D8D2] PRIMARY KEY CLUSTERED  ([str_ticketcaseid])
GO
