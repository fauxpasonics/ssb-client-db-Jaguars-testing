...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__CustomerA__CopyL__7CFA4D51] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[CustomerAddress] ADD CONSTRAINT [PK__Customer__B4F003158468EC3A] PRIMARY KEY CLUSTERED  ([customeraddressid])
GO
