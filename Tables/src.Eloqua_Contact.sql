...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Co__ETL_C__4E84E4EB] DEFAULT (getdate()),
[ID] [int] NOT NULL,
...
GO
ALTER TABLE [src].[Eloqua_Contact] ADD CONSTRAINT [PK__Eloqua_C__3214EC27B233A00A] PRIMARY KEY CLUSTERED  ([ID])
GO
