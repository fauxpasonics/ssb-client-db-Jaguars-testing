...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Inser__1BC821DD] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Updat__1CBC4616] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_PriceCode_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Price__3213E83F44323575] PRIMARY KEY CLUSTERED  ([id])
GO
