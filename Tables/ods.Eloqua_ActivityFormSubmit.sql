...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__6D823440] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__6E765879] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__6F6A7CB2] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityFormSubmit] ADD CONSTRAINT [PK__Eloqua_A__3214EC27703A7D10] PRIMARY KEY CLUSTERED  ([ID])
GO
