...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEvent__Create__79C80F94] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEvent__Update__7ABC33CD] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimEvent__IsDele__7BB05806] DEFAULT ((0)),
[DeleteDate] [datetime] NULL,
[IsClosed] [bit] NOT NULL CONSTRAINT [DF__DimEvent__IsClos__7CA47C3F] DEFAULT ((0)),
