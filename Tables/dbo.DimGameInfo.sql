...
[OvertimePeriods] [int] NULL CONSTRAINT [DF__DimGameIn__Overt__35DCF99B] DEFAULT ((0)),
[CreatedBy] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedBy] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimGameIn__Creat__36D11DD4] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimGameIn__Updat__37C5420D] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimGameIn__IsDel__38B96646] DEFAULT ((0)),
