...
[ETL_CreatedDate] [datetime] NULL CONSTRAINT [DF__TMAPI_Att__ETL_C__3B95D2F1] DEFAULT (getdate()),
...
GO
ALTER TABLE [src].[TMAPI_AttendanceResult] ADD CONSTRAINT [PK__TMAPI_At__7EF6BFCDCEDFB44E] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
