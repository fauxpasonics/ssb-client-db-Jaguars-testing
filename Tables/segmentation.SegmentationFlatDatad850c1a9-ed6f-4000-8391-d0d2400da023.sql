CREATE TABLE [segmentation].[SegmentationFlatDatad850c1a9-ed6f-4000-8391-d0d2400da023]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatad850c1a9-ed6f-4000-8391-d0d2400da023] ADD CONSTRAINT [pk_SegmentationFlatDatad850c1a9-ed6f-4000-8391-d0d2400da023] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDatad850c1a9-ed6f-4000-8391-d0d2400da023] ON [segmentation].[SegmentationFlatDatad850c1a9-ed6f-4000-8391-d0d2400da023] ([_rn])
GO
