...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__475C8B58] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__4850AF91] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__4944D3CA] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityEmailOpen] ADD CONSTRAINT [PK__Eloqua_A__3214EC274DE5124A] PRIMARY KEY CLUSTERED  ([ID])
GO
