...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Creat__75035A77] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Updat__75F77EB0] DEFAULT (getdate()),
[IsDeleted] [bit] NULL CONSTRAINT [DF__DimSeason__IsDel__76EBA2E9] DEFAULT ((0)),
