...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__PhoneCall__CopyL__71889AA5] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[PhoneCall] ADD CONSTRAINT [PK__PhoneCal__0FC8C7C4F33BA6C9] PRIMARY KEY CLUSTERED  ([activityid])
GO
