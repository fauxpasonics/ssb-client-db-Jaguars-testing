...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Opportuni__CopyL__74650750] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Opportunity] ADD CONSTRAINT [PK__Opportun__736BF79CF5B9D85E] PRIMARY KEY CLUSTERED  ([opportunityid])
GO
