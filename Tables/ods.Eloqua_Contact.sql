...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Co__ETL_C__49C02FCE] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Co__ETL_U__4AB45407] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Co__ETL_I__4BA87840] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_Contact] ADD CONSTRAINT [PK__Eloqua_C__3214EC27F5FB45D7] PRIMARY KEY CLUSTERED  ([ID])
GO
