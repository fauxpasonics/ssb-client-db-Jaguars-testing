...
GO
CREATE CLUSTERED INDEX [ClusteredIndex-20161104-153532] ON [archive].[CleanDataOutput] ([BatchId], [ContactId], [ContactStatusCode], [ContactStatus], [SourceContactId])
GO
CREATE NONCLUSTERED INDEX [IX_CleanDataOutput_Custom2] ON [archive].[CleanDataOutput] ([Input_Custom2]) INCLUDE ([ETL_CreatedDate], [Input_SourceSystem], [SourceContactId])
GO
