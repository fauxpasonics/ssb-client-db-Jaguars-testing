...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_C__5A6F5FCC] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_U__5B638405] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_I__5C57A83E] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_Email] ADD CONSTRAINT [PK__Eloqua_E__3214EC277CD6A37A] PRIMARY KEY CLUSTERED  ([ID])
GO
