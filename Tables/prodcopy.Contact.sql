...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Contact__CopyLoa__6616E7F9] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Contact] ADD CONSTRAINT [PK__Contact__7126F91D8C4E7D63] PRIMARY KEY CLUSTERED  ([contactid])
GO
