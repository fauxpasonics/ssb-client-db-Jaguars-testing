...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__InsertDa__25518C17] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__UpdateDa__2645B050] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[ods__TM_Tex_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Tex__3213E83F5DE51D74] PRIMARY KEY CLUSTERED  ([id])
GO
