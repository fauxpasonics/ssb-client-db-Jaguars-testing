...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Inser__0A9D95DB] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Updat__0B91BA14] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_AvailSeats_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Avail__3213E83F6E7B1974] PRIMARY KEY CLUSTERED  ([id])
GO
