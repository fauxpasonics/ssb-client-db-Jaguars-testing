CREATE TABLE [segmentation].[SegmentationFlatData2d130999-de0b-4b30-8772-047fea42d4a7]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData2d130999-de0b-4b30-8772-047fea42d4a7] ADD CONSTRAINT [pk_SegmentationFlatData2d130999-de0b-4b30-8772-047fea42d4a7] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData2d130999-de0b-4b30-8772-047fea42d4a7] ON [segmentation].[SegmentationFlatData2d130999-de0b-4b30-8772-047fea42d4a7] ([_rn])
GO
