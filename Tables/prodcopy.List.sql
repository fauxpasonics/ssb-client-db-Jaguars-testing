...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_List] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[List] ADD CONSTRAINT [PK__List__7D4781536FE2B8BA] PRIMARY KEY CLUSTERED  ([listid])
GO
