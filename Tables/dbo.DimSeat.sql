...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeat__Created__15702A09] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeat__Updated__16644E42] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimSeat__IsDelet__1758727B] DEFAULT ((0)),
[DeleteDate] [datetime] NULL CONSTRAINT [DF__DimSeat__DeleteD__184C96B4] DEFAULT ((0)),
