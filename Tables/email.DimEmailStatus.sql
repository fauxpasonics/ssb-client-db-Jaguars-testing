...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailS__Creat__7BED5396] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailS__Updat__7CE177CF] DEFAULT (getdate()),
