...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Inser__160F4887] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Updat__17036CC0] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_ManifestSeat_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Manif__3213E83FDB77686C] PRIMARY KEY CLUSTERED  ([id])
GO
